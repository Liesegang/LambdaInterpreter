...
class Variable(Expression):
    """Encapsulate a lambda calculus variable.

    Attributes:
        name (str): The variavle's ID
    """
...
class Application(Expression):
    """Encapsulate a lambda calculus function call.
...
class Abstraction(Expression):
    """Encapsulate a function in lambda calculus.

    Attributes:
        parameter (Variale): The argument variable
